...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            style={'text-align-last': 'center', 'width': '80%', 'padding': '3px', 'font-size': '20px'}
        )
    ]),
...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        recession_data = data.query('Recession == 1')
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales,
                ...
                title="Average Automobile Sales of each Vehicle Type"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec,
                ...
                names=exp_rec.index,
                title='Total Expenditure on each Vehicle Type during Recession'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
	...
	# Hint:Use the columns Month and Automobile_Sales.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(mas, 
                x='Month',
                y='Automobile_Sales',
                title="Average Automobile Sales Over the Months"))
